...
4. `step3_modeling.py` OR `main_training_pipeline.py` → Modeling and optimization
...
└── modeling/                               # Modeling Execution Logs
    └── [Placeholder for modeling logs if step3_modeling.py generates separate logs]
```
...
**Outputs**:
- Model artifacts: `outputs_optimized/artifacts/*.pkl`
- Performance metrics: `outputs_optimized/logs/*.csv`
- Visualizations: `outputs_optimized/plots/*.png`
...
- **AUC**: 0.7995 (95% CI: [0.7814, 0.8177])
- **AUPRC**: 0.5774 (95% CI: [0.5406, 0.6117])
- **Brier Score**: 0.1383 (95% CI: [0.1309, 0.1453])
...
- **Hyperparameter Optimization**: Optuna (TPE Sampler, 30 trials, nested CV)
- **Cross-Validation**: Stratified 5-fold CV
- **Threshold Optimization**: Youden's J, F2-score, Cost-based
...
- **Robustness**: Bootstrap CI (1000 iterations), Subgroup evaluation
